...
export async function Footer({ global }: { global: Global | null }) {
  ...
  return (
    <footer className="grid_ px-4 py-4 gap-y-12 lg:gap-y-20 bg-natural dark:bg-black">
      ...
      <div className="col-start-1 col-span-12 lg:col-start-1 lg:col-span-16 link">© {currentYear} {global?.siteName || 'EPITOMESTUDIO'} Ltd</div>
