...
export function HireEquipmentForm({ onClose }: Props) {
  ...
  return (
    <div className="grid_ py-4 gap-y-6">
      ...
      {formData.items.length > 0 && (
        <div className="row-start-3 col-start-1 col-span-12 sm:col-start-2 sm:col-span-10 lg:col-start-16 lg:col-span-5 flex flex-col gap-2">
          <div className="bg-black/5 dark:bg-natural/5 rounded flex flex-col overflow-hidden">
              <button onClick={() => setIsSummaryOpen(!isSummaryOpen)}className='flex flex-row justify-between w-full lg:cursor-default p-4' type="button">
                ...
                <Icon name="icon-chevron" className={`w-3 h-3 fill-black dark:fill-natural lg:hidden transition-transform duration-lg ease-es ${isSummaryOpen ? 'rotate-270' : 'rotate-90'}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" aria-hidden="true"><title>Toggle Summary</title></Icon>
              </button>
                    ...
                    <div className='flex flex-col gap-0'>
                      {formData.items.map((item) => (
                        <div key={item.id} className="flex justify-between">
                          ...
                          <div className='basis-1/6 text-right'>{item.quantity}</div>
                    ...
                    <div className='flex flex-col gap-1'>
                      <div className="flex justify-between font-medium text-lg">
                        <div className="flex flex-row gap-2 justify-start items-center">
                          ...
                          >
                            <Icon name="icon-info" className="w-4 h-4 fill-black dark:fill-natural" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" aria-hidden="true"><title>Info</title></Icon>
                          </button>
                        </div>
                      ...
                      <AnimatedMessage show={showPriceInfo} className="flex items-start gap-2 text-xs text-black/60 dark:text-natural/60 px-2">
                        <Icon name="icon-subArrow" className="w-3 h-3 fill-black/60 dark:fill-natural/60 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" aria-hidden="true"><title>Note</title></Icon>
      ...
      {/* Step 1: Your Info */}
      {currentStep === 1 && (
        <div className={`col-start-1 col-span-12 sm:col-start-2 sm:col-span-10 lg:col-start-5 lg:col-span-10 flex flex-col gap-2 transition-opacity duration-md ease-es ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
      ...
      {currentStep === 2 && (
        <div className={`col-start-1 col-span-12 sm:col-start-2 sm:col-span-10 lg:col-start-5 lg:col-span-10 flex flex-col gap-2 transition-opacity duration-md ease-es ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
          ...
          <div className='field-wrapper'>
            ...
            <AnimatedMessage show={formData.hireStudio} className="flex items-center gap-2 note">
              <Icon name="icon-subArrow" className="h-3 w-3 fill-black dark:fill-natural mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" aria-hidden="true"><title>Hire Studio note</title></Icon>
      ...
      {/* Step 3: Review */}
      {currentStep === 3 && (
        <div className={`col-start-1 col-span-12 sm:col-start-2 sm:col-span-10 lg:col-start-5 lg:col-span-10 flex flex-col gap-6 transition-opacity duration-md ease-es ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
