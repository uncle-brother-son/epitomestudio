...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageTitle = production?.title || 'Production'
  const pageDescription = production?.metaDescription || 'Our production services'
      ...
      {production?.video?.asset && (
        <div className="col-start-1 col-span-12 lg:col-start-12 lg:col-span-13">
          <VideoPlayer
            ...
            poster={production.videoPoster ? urlFor(production.videoPoster).width(800).height(1000).url() : undefined}
            priority={true}
